...
export default function Index() {
  ...
  const [screenState, setScreenState] = useState<"screen1" | "earnings">(
    "screen1",
  );
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      ...
      if (screenState === "screen1") {
        ...
        scrollInputRef.current = Math.max(
          0,
          Math.min(scrollInputRef.current, maxScrollInput),
        );
        ...
        const burstProgress = Math.max(
          0,
          (currentScale - burstStartScale) / burstRange,
        );
    ...
    <>
      ...
      <div
        style={{
          ...
          transform:
            screenState === "screen1"
              ? `scale(${1 + whiteOverlayOpacity * 0.1})`
              : "scale(1)",
          pointerEvents:
            screenState === "screen1" && whiteOverlayOpacity > 0.9
              ? "auto"
              : "none",
        }}
      />
        ...
        {screenState === "earnings" && (
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "linear-gradient(90deg, #F3E4FF 0%, #D2E8FA 40%, #E3FCFF 100%)",
              filter: "blur(144px)",
              zIndex: 0,
              pointerEvents: "none",
              opacity: 1,
